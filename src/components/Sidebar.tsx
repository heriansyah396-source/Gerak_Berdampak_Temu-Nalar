...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="hidden md:flex w-72 bg-slate-950 text-slate-100 flex-col h-screen fixed top-0 left-0 border-r border-slate-800/80 shadow-2xl z-30 select-none">
      {/* Brand Header */}
